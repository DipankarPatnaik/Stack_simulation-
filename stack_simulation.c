...
// Push operation with detailed explanation
void push(Stack* s, int value) {
    printf("\n");
...
// Pop operation with detailed explanation
int pop(Stack* s) {
    printf("\n");
...
// Peek operation with detailed explanation
int peek(Stack* s) {
    printf("\n");
...
// Display stack with visualization
void printStackVisualization(Stack* s, const char* operation) {
    printf("\n");
    ...
    printf("\n");
    printf("  VISUAL STACK (LIFO - Last In, First Out):\n\n");
